...
const TARGETS = [
    { year: 2024, months: [11, 12] },
    { year: 2025, months: [1, 11, 12] }
];
...
function regenerateAll() {
    console.log('Starting Global Data Regeneration...');

    DISTRICTS.forEach(district => {
        TARGETS.forEach(({ year, months }) => {
            const dir = path.join(__dirname, `../data/${district}/${year}`);
            ...
            months.forEach(month => {
                ...
                console.log(`Generated: ${district}/${year}/${fileName}`);
            });
        });
    });
